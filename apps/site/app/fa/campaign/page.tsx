...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/fa/campaign',
  },
  openGraph: {
    type: 'website',
    locale: 'fa_IR',
    url: `${siteConfig.url}/fa/campaign`,
